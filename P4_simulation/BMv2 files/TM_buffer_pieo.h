...
std::vector<std::shared_ptr<bm::pieo_scheduler::fifo_bank>> bm::pieo_scheduler::FB = { NULL};

unsigned int bm::pieo_scheduler::time_now = 0;
...
unsigned int number_of_update_ranks_all_level = (bm::pieo_scheduler::number_of_pkts_per_queue_each_level[0]*bm::pieo_scheduler::number_of_queues_per_level[0] * bm::pieo_scheduler::number_levels);

std::vector<unsigned int> bm::pieo_scheduler::new_ranks_each_level(number_of_update_ranks_all_level);

std::vector<unsigned int> bm::pieo_scheduler::flow_id_not_empty_each_level(number_of_update_ranks_all_level);

std::queue<unsigned int> bm::pieo_scheduler::pkt_ptr_queue;

unsigned int bm::pieo_scheduler::use_updated_rank = 0;
unsigned int bm::pieo_scheduler::shaping = 0;
unsigned int bm::pieo_scheduler::number_of_enqueue_packets = 0;
unsigned int bm::pieo_scheduler::number_of_read_packets = 0;
unsigned int bm::pieo_scheduler::number_of_dequeue_packets = 0;
unsigned int bm::pieo_scheduler::switch_is_ready = 1;

std::queue<unsigned int> pkt_ptr_queue;

int bm::pieo_scheduler::start_time = 0;
int bm::pieo_scheduler::last_time = 0;

std::vector<unsigned int> bm::pieo_scheduler::pkt_levels_ranks = {0};
...
bm::pieo_scheduler dequeue_scheduler; // create object of the pieo_scheduler class.
 public:
	struct buffer {
