...
std::vector<std::shared_ptr<bm::pFabric_scheduler::fifo_bank>> bm::pFabric_scheduler::FB = { NULL};

unsigned int bm::pFabric_scheduler::time_now = 0;
unsigned int bm::pFabric_scheduler::number_levels = 1;

std::vector<unsigned int> bm::pFabric_scheduler::number_of_queues_per_level = {1};
std::vector<unsigned int> bm::pFabric_scheduler::number_of_pkts_per_queue_each_level = {1024};

unsigned int sum_all_queues = bm::pFabric_scheduler::number_of_queues_per_level[0];

unsigned int number_of_update_ranks_all_level = (bm::pFabric_scheduler::number_of_pkts_per_queue_each_level[0]*bm::pFabric_scheduler::number_of_queues_per_level[0] * bm::pFabric_scheduler::number_levels);

std::vector<unsigned int> bm::pFabric_scheduler::new_ranks_each_level(number_of_update_ranks_all_level);

std::vector<unsigned int> bm::pFabric_scheduler::flow_id_not_empty_each_level(number_of_update_ranks_all_level);

std::queue<unsigned int> bm::pFabric_scheduler::pkt_ptr_queue;

unsigned int bm::pFabric_scheduler::use_updated_rank = 0;
unsigned int bm::pFabric_scheduler::shaping = 0;
unsigned int bm::pFabric_scheduler::number_of_enqueue_packets = 0;
unsigned int bm::pFabric_scheduler::number_of_read_packets = 0;
unsigned int bm::pFabric_scheduler::number_of_dequeue_packets = 0;
unsigned int bm::pFabric_scheduler::switch_is_ready = 1;

std::queue<unsigned int> pkt_ptr_queue;

int bm::pFabric_scheduler::start_time = 0;
int bm::pFabric_scheduler::last_time = 0;

std::vector<unsigned int> bm::pFabric_scheduler::pkt_levels_ranks = {0};
...
bm::pFabric_scheduler dequeue_scheduler; // create object of the pFabric_scheduler class.
 public:
	struct buffer {
