...
control MyIngress(inout headers hdr,
    ...
    register<bit<32>>(1) delete_this_reg1;
    register<bit<32>>(1) delete_this_reg2;
    register<bit<32>>(1) delete_this_reg3;

    apply {

        delete_this_reg1.write(0,hdr.ipv4.options);
        delete_this_reg2.write(0,hdr.ipv4.srcAddr);
        delete_this_reg3.write(0,hdr.ipv4.dstAddr);
